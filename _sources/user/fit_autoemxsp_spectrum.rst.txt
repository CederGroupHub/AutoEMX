.. _fit_autoemxsp_spectrum_tutorial:


Tutorial: Fit and quantify individual spectra acquired with `AutoEMXSp`
=======================================================================

This tutorial shows how to fit--and optionall quantify-- a single EDS spectrum,
using the ``Fit_Quant_Single_AutoEMXSp_Spectrum.py`` script.
...
Open ``autoemxsp/scripts/Fit_Quant_Single_AutoEMXSp_Spectrum.py``.
